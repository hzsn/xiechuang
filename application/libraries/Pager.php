...
class Pager
{
	...
	private function set_style(){
		...
		$pre = '<li><a href="'.$this->base_link_url.'1">首页</a></li><li class=""><a href="'.$this->base_link_url.($this->cur_page-1).'">&laquo;上一页</a></li>';
		$dis_pre = '<li class="disabled"><a href="javascript:void(0);">首页</a></li><li class="disabled"><a href="javascript:void(0);">&laquo;上一页</a></li>';
		$next = '<li><a href="'.$this->base_link_url.($this->cur_page + 1).'">下一页&raquo;</a></li><li><a href="'.$this->base_link_url.$this->page_row.'">末页</a></li>';
		$dis_next = '<li class="disabled"><a href="javascript:void(0);">下一页&raquo;</a></li><li class="disabled"><a href="javascript:void(0);">末页</a></li>';
